                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="row top_tiles">
                      <label>Introduzca el correo electrónico del usuario que se eliminará</label>
                      <div class="input-group" style="margin-bottom: 21px">
                        <input type="text" class="form-control form-control" placeholder="correo de usuario">
                        <span class="input-group-btn">
