...
<html lang="en">
  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <label>Introduzca el código de la colección que se retirará</label>
                      <div class="input-group" style="margin-bottom: 21px">
                        <input type="text" class="form-control form-control" placeholder="código de colección" id="txt-codigo-coleccion">
                        <span class="input-group-btn">
                          <button class=" btn btn-default" type="button" id="btn-eliminar-coleccion">Eliminar</button>
                        </span>
                      </div>
                    </div>
                  </div>
    ...
    <script src="../js/retiro_coleccion.js"></script>
