        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h3>Administrar colecciones</h3>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <div class="row top_tiles">
                      <a href="listado_coleccion.php" class="link-panel">
                      ...
                      <a href="registro_coleccion.php" class="link-panel">
                        <div class="panel-opcion">
                          <div class="uno-panel">
                            <div class="dos-panel">
                      ...
                      <a href="retiro_coleccion.php" class="link-panel">
                        <div class="panel-opcion">
                          <div class="uno-panel">
                            <div class="dos-panel">
                      ...
                      <a href="#" class="link-panel">
                        <div class="panel-opcion">
                          <div class="uno-panel">
                            <div class="dos-panel">
                              <p><span><i class="fa fa-pencil"></i></span></p>
                              <p>Editar</p>
                            </div>
                          </div>
                        </div>
