...
<html lang="en">
  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <label>Introduzca el código del libro que se retirará</label>
                      <div class="input-group" style="margin-bottom: 21px">
                        <input type="text" class="form-control" placeholder="código del libro" id="txt-codigo-libro">
                        <span class="input-group-btn">
                          <button class=" btn btn-default" id="btn-eliminar-libro">Eliminar</button>
                        </span>
                      </div>
                    </div>
                  </div>
    ...
    <script src="../js/retiro_libro.js"></script>    
