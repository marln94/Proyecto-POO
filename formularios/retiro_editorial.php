...
<html lang="en">
  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <label>Introduzca el código de la editorial que se retirará</label>
                      <div class="input-group" style="margin-bottom: 21px">
                        <input type="text" class="form-control form-control" placeholder="código de editorial" id="txt-codigo-editorial">
                        <span class="input-group-btn">
                          <button class=" btn btn-default" type="button" id="btn-eliminar-editorial">Eliminar</button>
                        </span>
                      </div>
                    </div>
                  </div>
    ...
    <script src="../js/retiro_editorial.js"></script>
